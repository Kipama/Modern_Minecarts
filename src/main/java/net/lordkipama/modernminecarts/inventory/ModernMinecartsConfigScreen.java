...
public class ModernMinecartsConfigScreen extends Screen {
    ...
    private void addConfigEntries() {
        ...
        this.configList.addConfigEntry(new ToggleEntry(
                "Enable Furnace Minecart Chunkloading",
                this.enableFurnaceMinecartChunkloading,
                DEFAULT_ENABLE_FURNACE_MINECART_CHUNKLOADING
        ));
        ...
        this.configList.addConfigEntry(new ToggleEntry(
                "Enable Powered Detector Rail",
                this.enablePoweredDetectorRail,
                DEFAULT_ENABLE_POWERED_DETECTOR_RAIL
        ));
