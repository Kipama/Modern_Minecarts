...
public class CustomFurnaceFuelSlot extends Slot {
    private final FurnaceMinecartMenu menu;

    public CustomFurnaceFuelSlot(FurnaceMinecartMenu pFurnaceMenu, Container pFurnaceContainer, int pSlot, int pXPosition, int pYPosition) {
