                        ...
                        if (block.equals(Blocks.RAIL)) {
                            if (!world.isClient()) {
                                ...
                                if (blockState.get(shapeProperty) == RailShape.ASCENDING_NORTH) {
                                    ...
                                    gotReplaced = true;
                                } else if (blockState.get(shapeProperty) == RailShape.ASCENDING_SOUTH) {
                                    world.setBlockState(pos, ModBlocks.RAIL_JUMP.getStateWithProperties(blockState), 3);
                                    gotReplaced = true;
                                } else if (blockState.get(shapeProperty) == RailShape.ASCENDING_EAST) {
                                    world.setBlockState(pos, ModBlocks.RAIL_JUMP.getStateWithProperties(blockState), 3);
                                    gotReplaced = true;
                                } else if (blockState.get(shapeProperty) == RailShape.ASCENDING_WEST) {
                                    world.setBlockState(pos, ModBlocks.RAIL_JUMP.getStateWithProperties(blockState), 3);
                                    gotReplaced = true;
